            ...
            <div className="client_contact_header">
              <div className="conversation_filter">
                <div className="conversation_filter_by xl9">
                  ...
                  <img alt="sendit" src="img/Arrow - Down 2.png" />
                </div>
              </div>
          ...
          <div className="client_inbox l10 l-off sm-off sm10">
                ...
                <div className="individual_message">
                  <div className="individual_message_row  sm8 m8">
                    ...
                    <div className="message_details sm8 m7">
                      <p>Esther Howard</p>
                      <p className="sm9">
                        This is long text Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Etiam ac sagittis, nibh
                        leo. Nulla ullamcorper.
                      </p>
                    </div>
                  </div>
            ...
            <div className="client_inbox_chat_footer">
              <div className="chat_inbox_input">
                ...
                />
                <div onClick={handleSubmit} className="chat_submit">

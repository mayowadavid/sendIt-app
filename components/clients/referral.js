    ...
    <ClientLayout>
      ...
      <div className="shipper_settings_row">
        <div className="referral_message">
          <p>
            invite your friends to join sendit. if they sign up and make their
            first subscription you get 50% referal comm ission which you can use
            for subscription and withdraw to your bank.
          </p>
        </div>
        <div className="referral_flow flex_column">
          ...
          <div className="referral_row_content flex_row">
            <div className="referral_content_col m9 m-mg-tp10 sm-mg-tp10 sm9 flex_column">
              ...
              <p>Send Invitation</p>
              <p className="xl10">
                Send your referral link to friends and tell them how cool Sendit
                is.
              </p>
            </div>
            <div className="referral_content_col m9 m-mg-tp10 sm-mg-tp10 sm9 flex_column">
              ...
              <p>Registration</p>
              <p className="xl10">
                Let them register to our services using our referral link.
              </p>
            </div>
            <div className="referral_content_col m9 m-mg-tp10 sm-mg-tp10 sm9 flex_column">
              <div className="refferal_icon_wrap_sm xl-off m-on-flex sm-on-flex flex_row">
              ...
              <p>Commission</p>
              <p className="xl10">
                Get instant commission after first subscription payment plan.
              </p>
            </div>
          </div>
        </div>
        <div className="referal_row_invite">
          ...
          <p>
            Input your friends email address to send them invitation to join
            Sendit.
          </p>
        ...
        <div className="referal_row_invite m-mg-tp10">
          ...
          <p>
            ...
            sending on your social media.
          </p>
          <div className="referel_form flex_row">
            <div className="referal_form_code m10 l10 m-mg-tp10 flex_row">
              <p>#ffvvv64f433e</p>
              {copySuccess !== "Copied!" ? (
                <p className="m-off" onClick={copyReferalLink}>
                  Copy link
                </p>
              ) : (
                <p
                  className={`m-off ${
                    copySuccess == "Copied!" ? "green" : "red"
                  }`}
                >
                  {copySuccess}
                </p>
